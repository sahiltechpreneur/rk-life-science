    ...
    return (
        <div className="space-y-5">
            ...
            <div>
                ...
                <p className="text-sm text-gray-500">Manage registered users and their accounts</p>
            </div>
                                    ...
                                    <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                                        ...
                                        <td className="px-5 py-4">
                                            <div className="flex flex-wrap gap-1.5">
                                                ...
                                                {user.is_blocked && (
                                                    <span className="inline-flex items-center gap-1 px-2 py-0.5 text-[10px] font-medium rounded-full bg-red-50 text-red-600">
